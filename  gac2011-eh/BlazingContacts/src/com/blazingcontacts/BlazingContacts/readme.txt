...
5.  N/A If 4. is not done, at least data from the join activity should be put into data for the start activity.
...
5. StartActivity (changed maximum time to 1hr, see 4,5)
6. ServerException
